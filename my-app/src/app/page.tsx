...
const Home: FC = () => {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url(https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTZZCim6EYe2MQl7AZve1mwyDWnvSvPYJa36g&s)`,
        ...
        >
            <div className="flex h-[100vh] pt-24">
                ...
                <div ref={heroRef} className="w-2/3 flex flex-col items-center justify-center text-center px-6">
                    <h1 className="text-6xl font-extrabold text-teal-400 shadow-lg drop-shadow-lg">
                        Empowering your understanding of blockchain—unlock the future of technology!
                    </h1>
                </div>
            ...
            <div ref={descriptionRef} className="absolute w-1/2 mx-auto top-[80vh] left-16 p-6">
                ...
                >
                    ...
                    <p className="mt-4 text-xl leading-relaxed text-gray-300">
                        This blockchain knowledge AI bot app is designed to empower users with instant access to information about blockchain technology, offering a seamless and interactive learning experience. With advanced AI capabilities, users can ask questions, explore complex concepts, and receive tailored explanations that cater to their individual learning needs.
                        <br /><br />
                        Example prompts include:
                        <br /><br />
                        👉“What are the foundational principles of blockchain technology?”<br />
                        👉“Can you explain how smart contracts work?”<br />
                        👉“What are the differences between proof of work and proof of stake?”<br />
                        👉“How does decentralization enhance security in blockchain?”<br />
                        👉“What are the latest trends in the cryptocurrency market?”<br />
                        👉“Can you summarize the benefits of using blockchain in supply chain management?”<br />
                        <br />
                        This app aims to make blockchain knowledge accessible and engaging, breaking down barriers to understanding while fostering a passion for this transformative technology. By leveraging AI to deliver immediate support and insights, it empowers users to enhance their understanding and confidence in blockchain, paving the way for informed decision-making and innovation.
                    </p>
                </div>
            </div>
